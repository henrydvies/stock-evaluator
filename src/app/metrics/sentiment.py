...
class StockSentimentMetric(BaseMetric):
    ...
    async def compute(self, ticker: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "sentiment.narrative_buzz": res.narrative_buzz,
            "sentiment.narrative_article_count_proxy": res.narrative_article_count_proxy,
            "sentiment.narrative_sector_news_score": res.narrative_sector_news_score,
            "sentiment.narrative_vs_sector_news_score": res.narrative_vs_sector_news_score,
